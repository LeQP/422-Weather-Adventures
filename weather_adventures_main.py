'''
weather_adventures_main.py
--------
Author: Alexa Roskowski
Created: 3/3/2023
Last Modified: 3/12/2023
Purpose: This is the file that will be run by the user, and acts as the intermediary between all the files LIES

Revision History (Date | Author | Modifications)
----------------------------------------------
3/6/2023  | Alexa Roskowski | Made the initial file and prototype of image_initializer
3/7/2023  | Alexa Roskowski | Added more_info and updated the image_initializer
3/9/2023  | Alexa Roskowski | Worked on combining with Activcity Recommender and InfoPopup
3/10/2023 | Alexa Roskowski | Finished interaction between InfoPopup and Activity Recommender
3/12/2023 | Alexa Roskowski | Signed off on final version
'''
